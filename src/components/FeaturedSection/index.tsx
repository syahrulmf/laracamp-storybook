    ...
    <div className="container mx-auto px-4 group">
      <div className="flex flex-col md:flex-row items-center justify-center gap-y-20 md:gap-y-0 gap-x-16 md:gap-x-28 xl:gap-x-36">
        ...
        <div className="relative md:group-odd:order-1 md:group-even:order-2">
          ...
          <div className="absolute rounded-xl bottom-0 right-0 bg-white z-10 transform translate-x-4 translate-y-4 md:translate-x-1/4 xl:translate-x-1/2 md:translate-y-1/2 p-4 w-56">
            <span className="flex items-center gap-x-2 mb-2">
              <span className="h-5 w-5 p-1 bg-green rounded-full flex items-center justify-center">
                <svg
                  viewBox="0 0 12 8"
                  fill="none"
