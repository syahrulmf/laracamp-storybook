...
function Button(props) {
    ...
    const children = (0, react_1.cloneElement)(returnChildren, {
        ...
        children: ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("span", { className: [
                    ...
                    ].join(" "), children: (0, jsx_runtime_1.jsxs)("svg", { className: "animate-spin w-5 h-5", viewBox: "0 0 28 28", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [(0, jsx_runtime_1.jsx)("circle", { opacity: "0.2", cx: "14", cy: "14", r: "13", className: "stroke-white", strokeWidth: "2" }), (0, jsx_runtime_1.jsx)("path", { d: "M14 1C21.1797 1 27 6.8203 27 14C27 18.0209 25.1745 21.6154 22.3071 24", className: "stroke-white", strokeWidth: "2" })] }) })] })),
    });
