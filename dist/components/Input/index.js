...
function Input(props) {
    ...
    if (props.type === "file" && isfileAcceptImageOnly) {
        ...
        renderInputImage = ((0, jsx_runtime_1.jsxs)("div", { className: "w-28 h-28 relative", children: [blobImage ? ((0, jsx_runtime_1.jsx)("span", { className: "flex rounded-full overflow-hidden w-full h-full", children: (0, jsx_runtime_1.jsx)("img", { src: blobImage, className: "object-cover", alt: "" }) })) : ((0, jsx_runtime_1.jsxs)("svg", { viewBox: "0 0 104 104", fill: "none", preserveAspectRatio: "xMidYmid meet", children: [(0, jsx_runtime_1.jsx)("circle", { cx: "52", cy: "52", r: "50", className: "stroke-soft-grey", "stroke-width": "4" }), (0, jsx_runtime_1.jsx)("circle", { cx: "52", cy: "36", r: "18", className: "stroke-soft-grey", "stroke-width": "4" }), (0, jsx_runtime_1.jsx)("path", { d: "M84.3013 90.5C79.0175 77.8722 66.5447 69 51.9998 69C37.4548 69 24.982 77.8722 19.6982 90.5", className: "stroke-soft-grey", "stroke-width": "4" })] })), (0, jsx_runtime_1.jsx)("label", { htmlFor: props.id, className: "absolute inset-0 cursor-pointer" }), (0, jsx_runtime_1.jsx)("label", { htmlFor: props.id, className: [
